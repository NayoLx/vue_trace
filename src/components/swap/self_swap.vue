...
<template>
	<div class="self_swap" @click="foo()">
		<div class="swap_group" @contextmenu.prevent="divRightClick($event)">
			<div class="swap_group_item" v-for="item in swapGroup" v-bind:key="item.groupId"
				@click="changeGroup(item.groupId)" :class="{ active: selected === item.groupId }">
				{{ item.groupName }}
			</div>
		</div>
		<div class="self-swap-table">
			<el-table height="300" row-key="id" :data="tableData" @row-contextmenu="rightClick"
				style="width: 100%; color: #fff" :header-cell-style="cellStyle" :cell-style="rowStyle"
				@row-click="onClick">
					...
					<template slot="header">
						<el-dropdown trigger="click" style="color: #fff">
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item @click.native="addSwap()">添加合约</el-dropdown-item>
								<el-dropdown-item @click.native="setSort()">标记排序</el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
					</template>
				...
				<el-table-column label="最新价" prop="recentQuotation" width="150">
				</el-table-column>
				<el-table-column label="涨幅" prop="amountIncreased" width="150">
				</el-table-column>
				<el-table-column label="涨跌" prop="increased" width="150">
				</el-table-column>
				<el-table-column label="买价" prop="beginningPrice" width="150">
				</el-table-column>
				<el-table-column label="卖价" prop="endingPrice" width="150">
				</el-table-column>
				<el-table-column label="买量" prop="buyingVolume" width="150">
				</el-table-column>
				<el-table-column label="卖量" prop="sellingVolume" width="150">
				</el-table-column>
				<el-table-column label="成交量" prop="volume" width="150"> </el-table-column>
				<el-table-column label="持仓量" prop="openInterest" width="150">
				</el-table-column>
				<el-table-column label="现量" prop="presentVolume" width="150">
				</el-table-column>
				<el-table-column label="涨停价" prop="limitUpPrice" width="150">
				</el-table-column>
				<el-table-column label="涨跌价" prop="limitDownPrice" width="150">
				</el-table-column>
				<el-table-column label="今开盘" prop="openingPrice" width="150">
				</el-table-column>
				<el-table-column label="昨收盘" prop="PrevClose" width="150">
				</el-table-column>
				<el-table-column label="最高价" prop="high" width="150">
				</el-table-column>
				<el-table-column label="最低价" prop="low" width="150">
				</el-table-column>
				<el-table-column label="成交额" prop="turnover" width="150">
				</el-table-column>
				<el-table-column label="交易所" prop="exchange" width="150">
				</el-table-column>
				<el-table-column label="行情更新时间" prop="updateTime" width="150">
				</el-table-column>
			</el-table>
		</div>
		...
		<div id="div_contextmenu" v-show="divMenuVisible" class="menu">
			<el-cascader-panel v-model="cascaderValue" :options="dieOptions" ref="cascaderRef" @change="onChange"
				:props="{ expandTrigger: 'hover' }" clearable></el-cascader-panel>
		</div>

		<el-dialog title="添加自选合约" :visible.sync="dialogVisible" width="60%" :close-on-click-modal="false" v-dialogDrag>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getGroup() {
				if (this.$store.state.user.server == 'fake') {
					this.swapGroup = getData().initView;
					this.groupOptions = [];
			...
			getTableData() {
				if (this.$store.state.user.server == 'fake') {
					this.tableData = getData().viewGroup;
					return;
				}
				var that = this;
				web
